...
const projects = [
  {
    ...
    description: "An advanced comprehensive interactive environment. Engineered with modern web technologies to deliver seamless performance, deep integrations, and an intuitive user interface.",
    image: "/acie_live.png",
  },
  {
    title: "Cravings",
    ...
    github: "https://github.com/rajkumarvns",
    description: "A highly responsive restaurant and food delivery application. Features real-time cart updates, beautiful UI animations, and a seamless checkout experience.",
  ...
  },
  {
    ...
    github: "https://github.com/rajkumarvns",
    description: "A real-time chat application built for instant communication. Incorporates websockets for live messaging, user authentication, and a sleek, dark-themed responsive design.",
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <TextReveal text="Projects" className="text-4xl sm:text-5xl md:text-6xl font-bold" />
        </div>
    ...
    >
      ...
      >
        ...
        <div className="relative w-full md:w-3/5 h-64 sm:h-80 md:h-full overflow-hidden border-b md:border-b-0 md:border-r border-white/10 bg-[#0a0a0a] p-4 sm:p-6 lg:p-8">
          <motion.div style={{ scale: imageScale }} className="w-full h-full relative rounded-xl overflow-hidden shadow-[0_0_40px_rgba(28,216,210,0.15)] border border-white/10">
            <Image
              src={project.image}
              alt={project.title}
              fill
